@nams189  @sp6 @reg
  Feature: NAMS-189: Publish AAM
    @test18901
    Scenario Outline:NAMS-189: Publish AAM
    ...
    @test18902
    Scenario Outline: NAMS-189: Publish AAM Manager User
      Given I Enter the "<Username>" and "<Password>"
    ...
    Scenario Outline: NAMS-189: Publish AAM Evidence
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
      And I Search the Name
      And I Move to "Document & Stakeholder Comms"
      And I capture the "AAM published info"
      Examples:
        |Username|Password|
        |AA_test1 |password@1|