@E2E @awp
  Feature: Assurance Work Package End 2 End Application
@testawp
  Scenario Outline: Audit Reports Type Assurance Work Package
    ...
    @testawp
    Scenario Outline:Assurance Work Package End 2 End Application Accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testawp
    Scenario Outline: AWP APM,AAM Relase/update the user
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testawp
    Scenario Outline: AWP Publish APM Manager Accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testawp
    Scenario Outline: AWP Publish AAM Manager Accpet
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testawp1
    Scenario Outline: AWP Exception and Issue indicator update
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testawp1
    Scenario Outline:AWP Issue and Exception Accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
     ...
     @testawp1
    Scenario Outline: AWP move to archive
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
