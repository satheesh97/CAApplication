@E2E @ChangeAudit
Feature: Change Audit End 2 End Application
  @ca
  Scenario Outline:Change Audit End 2 End Application
  ...
  @ca
  Scenario Outline:Change Audit  End 2 End Application Accept
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
  ...
  @ca
  Scenario Outline:  Change Audit Send Group Strategies for Group Strategy Team Review accept
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
  ...
  @ca
  Scenario Outline: Change Audit  APM,AAM Relase/update the user
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
  ...
  @ca
  Scenario Outline: Change Audit Publish APM Manager Accept
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
  ...
  @ca
  Scenario Outline:Change Audit  Publish AAM Manager Accpet
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
  ...
  @ca
  Scenario Outline: Change Audit MRCC indicator update
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
  ...
  @ca1
  Scenario Outline:Change Audit  MRCC MA Accept
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
  ...
  @ca1
  Scenario Outline: Change Audit  MRCC SME Accept
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
  ...
  @ca
  Scenario Outline: Change Audit MRCC AM Accept
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
  ...
  @ca12
  Scenario Outline: Change Audit move to archive
    Given I Enter the "<Username>" and "<Password>"
    Given  wait for "2" seconds
    And I  click the menu "Home"
    Then I click submenu "My Audits"
