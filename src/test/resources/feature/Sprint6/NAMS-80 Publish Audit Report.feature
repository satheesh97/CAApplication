@nams80 @sp6 @reg
  Feature: NAMS-80: Publish Audit Report
    @test8001
    Scenario Outline:NAMS-80: Publish Audit Report
    ...
    @test8002
    Scenario Outline:NAMS-80: Publish Audit Report Manager User
      Given I Enter the "<Username>" and "<Password>"
    ...
    Scenario Outline: NAMS-80: Publish Audit Report
      ...
      And I Search the Name
      And I Move to "Document & Stakeholder Comms"
      And I capture the "Audit Report published info"
      Examples:
        |Username|Password|
        |AA_test1 |password@1|