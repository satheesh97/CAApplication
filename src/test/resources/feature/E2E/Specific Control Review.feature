@E2E @SpecificControlReview
  Feature: Specific Control Review E2E Application
@scr
    Scenario Outline: Audit Reports Type Specific Control Review
    ...
    @testscr
    Scenario Outline:Specific Control Review End 2 End Application Accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testscr
    Scenario Outline: Specific Control Review  Send Group Strategies for Group Strategy Team Review accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testscr
    Scenario Outline: Specific Control Review AWP APM,AAM Relase/update the user
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testscr
    Scenario Outline: Specific Control Review Publish APM Manager Accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testscr
    Scenario Outline:Specific Control Review Publish AAM Manager Accpet
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testscr
    Scenario Outline:Specific Control Review Exception and Issue indicator update
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testscr
    Scenario Outline:Specific Control Review Issue and Exception Accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testscr
    Scenario Outline: Specific Control Review move to archive
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
