@E2E @SpecialVerificationReview
  Feature: Special Verification Review E2E Application
@testasvr1
    Scenario Outline: Audit Reports Type Special Verification Review
    ...
    @testasvr1
    Scenario Outline:Special Verification Review End 2 End Application Accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testasvr1
    Scenario Outline: Special Verification Review  Send Group Strategies for Group Strategy Team Review accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testasvr1
    Scenario Outline: Special Verification Review AWP APM,AAM Relase/update the user
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testasvr1
    Scenario Outline: Special Verification Review Publish APM Manager Accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testasvr1
    Scenario Outline:Special Verification Review Publish AAM Manager Accpet
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testasvr
    Scenario Outline:Special Verification Review Exception and Issue indicator update
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testasvr
    Scenario Outline:Special Verification Review Issue and Exception Accept
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
    ...
    @testasvr
    Scenario Outline: Special Verification Review move to archive
      Given I Enter the "<Username>" and "<Password>"
      Given  wait for "2" seconds
      And I  click the menu "Home"
      Then I click submenu "My Audits"
